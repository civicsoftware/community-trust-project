    ...
    <>
      ...
      <div className="m-12 mb-36 mt-24 mx-auto px-6 max-w-3xl lg:px-12">
        ...
        <section className="py-12">
          <p className="block font-sans prose prose-lg">
            Story-Centered Stakeholders (also called personas) are a key
            component in our storytelling methodology. We use them to build and
            extend empathy and define the unique needs of each stakeholder.
          ...
          <p className="block mt-6 font-sans prose prose-lg">
            Hear the stakeholders share their experiences in their own voice,
            via a multimedia experience:
          </p>
        </section>

        <h2 className="pt-6 text-xl font-semibold">Community</h2>
        ...
        <h2 className="pt-12 text-xl font-semibold">County</h2>
        <div className="grid gap-10 mt-6 bg-white lg:grid-cols-3">
          {loading && <p className="col-span-3">Loading...</p>}
          {error && <p className="col-span-3">Error loading data :(</p>}
          {!loading &&
        ...
        <h2 className="pt-12 text-xl font-semibold">CIVIC</h2>
        <div className="grid gap-10 mt-6 bg-white lg:grid-cols-3">
          {loading && <p className="col-span-3">Loading...</p>}
          {error && <p className="col-span-3">Error loading data :(</p>}
          {!loading &&
