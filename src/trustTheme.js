export default {
  button: {
    primary: {
        base: 'text-white bg-teal-dark hover:bg-teal-light border border-transparent',
        active: 'active:bg-teal-dark hover:bg-teal-light focus:shadow-outline-pink',
        disabled: 'opacity-50 cursor-not-allowed',
    },
    outline: {
        base: 'bg-white text-gray-600 border-gray-300 border dark:text-gray-400 focus:outline-none',
        active:
