      ...
      <>
        ...
        <div className="container mx-auto m-6 px-4 grid grid-cols-1 justify-center">
          ...
          <div className="text-xl justify-self-center">
            This is a very good mission statement that is concise and inspiring. Collaboration to center community.
          </div>
          <div className="text-4xl justify-self-center mt-40">
            <a href="/library" className="whitespace-nowrap text-gray-500 px-4 py-2 hover:text-gray-900">
          ...
          <div class="bg-gray-50 mt-40">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-around">
              <h2 class="text-3xl tracking-tight text-gray-900 sm:text-4xl">
                <span class="block"> We're building something important.</span>
                <span class="block text-indigo-600">Want to be a part?</span>
              </h2>
              <div class="mt-8 lex lg:mt-0 lg:flex-shrink-0">
                <Windmill.Button onClick={openModal} className="whitespace-nowrap inline-flex items-center justify-center px-4 py-2 m-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
